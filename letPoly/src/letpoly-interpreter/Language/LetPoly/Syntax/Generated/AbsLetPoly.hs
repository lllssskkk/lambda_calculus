...
-- | The abstract syntax of language LetPoly.

module Language.LetPoly.Syntax.Generated.AbsLetPoly where
...
data Atom' a = AVar a Ident | ATerm a (Term' a) | ACons a
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)
...
data Type' a
    = Arrow a (BaseType' a) (Type' a) | Base a (BaseType' a)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)

type BaseType = BaseType' BNFC'Position
data BaseType' a
    = Pair a (Type' a) (Type' a) | Nat a | Bool a | ListT a (Type' a)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)
