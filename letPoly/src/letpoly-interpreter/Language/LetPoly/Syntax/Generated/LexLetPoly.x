...
module Language.LetPoly.Syntax.Generated.LexLetPoly where
...
resWords =
  b "in" 18
    (b "[" 9
       ...
       (b "first" 14
          (b "else" 12 (b "cons" 11 (b "]" 10 N N) N) (b "false" 13 N N))
          (b "head" 16 (b "fix" 15 N N) (b "if" 17 N N))))
    (b "second" 27
       (b "lam" 23
          (b "isZero" 21
             (b "isSucc" 20 (b "isPred" 19 N N) N) (b "isnil" 22 N N))
          (b "nil" 25 (b "let" 24 N N) (b "pred" 26 N N)))
       (b "true" 31
          (b "tail" 29 (b "succ" 28 N N) (b "then" 30 N N))
          (b "{" 33 (b "zero" 32 N N) (b "}" 34 N N))))
  where
  b s n = B bs (TS bs n)
    where
    bs = s
