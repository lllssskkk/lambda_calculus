...
data Prog' a = Program a (Term' a)
  deriving stock (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)

type Atom = Atom' BNFC'Position

data Atom' a = AVar a Ident | ATerm a (Term' a)
  deriving stock (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)
...
data Type' a = Arrow a (Type' a) (Type' a) | Nat a | Bool a
  deriving stock (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)

newtype Ident = Ident String
  deriving stock (C.Eq, C.Ord, C.Show, C.Read)
