...
transTerm x = case x of
  ...
  Language.UntypedLC.Syntax.Generated.AbsUntypedLC.LetInTerm _ ident term1 term2 -> failure x
  Language.UntypedLC.Syntax.Generated.AbsUntypedLC.LambdaAbsTerm _ ident term -> failure x
